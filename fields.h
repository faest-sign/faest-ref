...
ATTR_CONST bf8_t bf8_load(const uint8_t* src);
...
ATTR_PURE bf64_t bf64_load(const uint8_t* src);
...
ATTR_PURE bf128_t bf128_load(const uint8_t* src);
...
ATTR_PURE bf192_t bf192_load(const uint8_t* src);
...
ATTR_PURE bf256_t bf256_load(const uint8_t* src);
