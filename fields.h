...
ATTR_PURE void bf128_sq_bit(bf128_t* out_tag, const bf128_t* in_tag);
...
ATTR_PURE void bf192_sq_bit(bf192_t* out_tag, const bf192_t* in_tag);
...
ATTR_PURE void bf256_sq_bit(bf256_t* out_tag, const bf256_t* in_tag);
