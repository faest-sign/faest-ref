...
BOOST_AUTO_TEST_CASE(test_leaf_hash_128_tv) {
  ...
  leaf_hash_128(digest.data(), universal_hashing_tvs::leaf_hash_128::uhash.data(),
                universal_hashing_tvs::leaf_hash_128::x.data());
  BOOST_TEST(digest == universal_hashing_tvs::leaf_hash_128::expected_h);
}

BOOST_AUTO_TEST_CASE(test_leaf_hash_192_tv) {
  std::array<uint8_t, 3 * BF192_NUM_BYTES> digest{};
  leaf_hash_192(digest.data(), universal_hashing_tvs::leaf_hash_192::uhash.data(),
                universal_hashing_tvs::leaf_hash_192::x.data());
  BOOST_TEST(digest == universal_hashing_tvs::leaf_hash_192::expected_h);
}

BOOST_AUTO_TEST_CASE(test_leaf_hash_256_tv) {
  std::array<uint8_t, 3 * BF256_NUM_BYTES> digest{};
  leaf_hash_256(digest.data(), universal_hashing_tvs::leaf_hash_256::uhash.data(),
                universal_hashing_tvs::leaf_hash_256::x.data());
  BOOST_TEST(digest == universal_hashing_tvs::leaf_hash_256::expected_h);
}
