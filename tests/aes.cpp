...
namespace aes_ctr_128_tv {
  constexpr std::array<uint8_t, 16> key = {0x42, 0x13, 0x4f, 0x71, 0x34, 0x89, 0x1b, 0x16,
                                           0x82, 0xa8, 0xab, 0x56, 0x76, 0x27, 0x30, 0x0c};
  constexpr std::array<uint8_t, 16> in  = {0x7b, 0x60, 0x66, 0xd6, 0x5a, 0x73, 0xd6, 0x00,
                                           0xa0, 0xae, 0xf0, 0x1c, 0x8b, 0x19, 0x17, 0x40};
  constexpr std::array<uint8_t, 16> out = {0x89, 0x13, 0xaf, 0x07, 0x31, 0xb5, 0x81, 0xdf,
...
namespace aes_ctr_192_tv {
  constexpr std::array<uint8_t, 24> key = {0x7f, 0x64, 0xa4, 0x6b, 0xbd, 0x02, 0x67, 0x2c,
                                           0xed, 0x19, 0xfb, 0x73, 0x5b, 0xf0, 0x46, 0xaf,
                                           0x23, 0x6e, 0x38, 0x79, 0x85, 0x13, 0x79, 0xd3};
  constexpr std::array<uint8_t, 32> in  = {0x2f, 0xae, 0x1b, 0x7c, 0x4a, 0x8f, 0xb6, 0x1c,
                                           0x15, 0x7c, 0x4d, 0xe2, 0x9d, 0x35, 0x62, 0x33,
                                           0x63, 0x94, 0x75, 0x39, 0x50, 0x2d, 0x7e, 0xa5,
                                           0xf7, 0x33, 0xd0, 0xca, 0x3c, 0xc2, 0xb5, 0xd0};
  constexpr std::array<uint8_t, 32> out = {0x1a, 0xb4, 0x2c, 0x3c, 0xde, 0xb6, 0xb5, 0x08,
                                           0xff, 0xc8, 0x3d, 0x5b, 0x48, 0x9f, 0x62, 0xca,
                                           0xdd, 0x3f, 0x53, 0x92, 0xbb, 0x4b, 0x0a, 0xe3,
                                           0xed, 0xf0, 0xe9, 0xe7, 0x0c, 0x4d, 0xb4, 0x2c};
...
namespace aes_ctr_256_tv {
  constexpr std::array<uint8_t, 32> key = {0xa9, 0x86, 0x63, 0xac, 0x8a, 0x05, 0x78, 0xbe,
                                           0xd7, 0x2c, 0x80, 0x91, 0x07, 0x67, 0xce, 0x11,
                                           0xf1, 0x79, 0x59, 0xde, 0x6a, 0x99, 0xbb, 0xdc,
                                           0x75, 0xb2, 0x04, 0x63, 0x6f, 0x1d, 0xd2, 0x5f};
  constexpr std::array<uint8_t, 32> in  = {0x78, 0xff, 0xd6, 0xd1, 0x95, 0x73, 0xdb, 0x9f,
                                           0xa4, 0x08, 0xe8, 0xcb, 0x29, 0xf8, 0x2e, 0x27,
                                           0x96, 0xe0, 0x8f, 0x0d, 0xf9, 0xf1, 0x8a, 0x1d,
                                           0x67, 0xd5, 0xec, 0x22, 0x14, 0x92, 0x32, 0x17};
  constexpr std::array<uint8_t, 32> out = {0xef, 0x34, 0x98, 0xa1, 0x9e, 0xab, 0x0a, 0x9e,
                                           0xad, 0x99, 0xd7, 0xf2, 0xe1, 0x68, 0xf5, 0xad,
                                           0x18, 0xdf, 0x02, 0x86, 0x6d, 0xf4, 0x2b, 0x80,
                                           0x24, 0xe3, 0x9e, 0x24, 0xeb, 0x51, 0x83, 0x67};
...
namespace rijndael_em_256_tv {
  constexpr std::array<uint8_t, 32> key = {0xc0, 0xcd, 0x0b, 0xed, 0xbe, 0x6a, 0x4c, 0x04,
                                           0xb3, 0x75, 0x89, 0x7d, 0x36, 0x9b, 0x7e, 0x62,
  ...
  constexpr std::array<uint8_t, 32> out = {0xf4, 0x1b, 0x6b, 0xb2, 0x22, 0x5c, 0xaf, 0xfc,
                                           0x82, 0x31, 0xcc, 0xe0, 0x21, 0x9e, 0x2c, 0xcc,
                                           0xb0, 0xf8, 0x0e, 0x68, 0x0d, 0xf2, 0xdf, 0xef,
                                           0xca, 0x1b, 0x96, 0x57, 0x18, 0x42, 0x00, 0x25};
