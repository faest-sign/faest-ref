...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes128) {
  ...
  uint8_t* extwit = aes_extend_witness(aes_ctr_128_tv::key, aes_ctr_128_tv::in, &params);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes192) {
  ...
  uint8_t* extwit = aes_extend_witness(aes_ctr_192_tv::key, aes_ctr_192_tv::in, &params);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes256) {
  ...
  uint8_t* extwit = aes_extend_witness(aes_ctr_256_tv::key, aes_ctr_256_tv::in, &params);
