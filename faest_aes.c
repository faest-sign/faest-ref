...
static void aes_128_inv_norm_constraints_prover(bf128_t* z_deg0, bf128_t* z_deg1, bf128_t* z_deg2,
...
static void aes_128_inv_norm_constraints_verifier(bf128_t* z_eval, const bf128_t* conjugates_eval,
  ...
  if (dosq) {
    for (unsigned i = 0; i < 9; i++) {
      ...
      for (unsigned int bit_j = 0; bit_j < 8; bit_j++) {
        tmp[bit_j] = (sbox_x_sq[i] >> bit_j) & 1;
      }
      C[i] = bf128_byte_bits_combine_array(tmp);
    }
    t = 1;
  } else {
    t = 0;
...
static void aes_192_sbox_affine_prover(bf192_t* out_deg0, bf192_t* out_deg1, bf192_t* out_deg2,
  ...
  if (dosq) {
    for (unsigned i = 0; i < 9; i++) {
      ...
      C[i] = bf192_byte_combine_bits_array(tmp);
    }
    t = 1;
  } else {
    t = 0;
...
static void aes_256_sbox_affine_prover(bf256_t* out_deg0, bf256_t* out_deg1, bf256_t* out_deg2,
  ...
  if (dosq) {
    for (unsigned i = 0; i < 9; i++) {
      ...
      C[i] = bf256_byte_combine_bits_array(tmp);
    }
    t = 1;
  } else {
    t = 0;
...
static void aes_128_sbox_affine_verifier(bf128_t* out_deg1, const bf128_t* in_deg1, bf128_t delta,
  ...
  if (dosq) {
    for (unsigned i = 0; i < 9; i++) {
      ...
      C[i] = bf128_byte_combine_bits_array(tmp);
    }
    t = 1;
  } else {
    t = 0;
...
static void aes_128_mix_columns_prover(bf128_t* y_deg0, bf128_t* y_deg1, bf128_t* y_deg2,
  ...
  bf128_t v1       = bf128_byte_combine_bits_array(one);
  bf128_t v2       = bf128_byte_combine_bits_array(two);
  bf128_t v3       = bf128_byte_combine_bits_array(three);
  if (dosq) {
    v1 = bf128_mul(v1, v1);
    v2 = bf128_mul(v2, v2);
    v3 = bf128_mul(v3, v3);
...
static void aes_192_mix_columns_prover(bf192_t* y_deg0, bf192_t* y_deg1, bf192_t* y_deg2,
  ...
  uint8_t two[8]   = {0, 1, 0, 0, 0, 0, 0, 0};
  uint8_t three[8] = {1, 1, 0, 0, 0, 0, 0, 0};
  bf192_t v1       = bf192_byte_combine_bits_array(one);
  bf192_t v2       = bf192_byte_combine_bits_array(two);
  bf192_t v3       = bf192_byte_combine_bits_array(three);
  if (dosq) {
    v1 = bf192_mul(v1, v1);
    v2 = bf192_mul(v2, v2);
    v3 = bf192_mul(v3, v3);
...
static void aes_256_mix_columns_prover(bf256_t* y_deg0, bf256_t* y_deg1, bf256_t* y_deg2,
  ...
  uint8_t two[8]   = {0, 1, 0, 0, 0, 0, 0, 0};
  uint8_t three[8] = {1, 1, 0, 0, 0, 0, 0, 0};
  bf256_t v1       = bf256_byte_combine_bits_array(one);
  bf256_t v2       = bf256_byte_combine_bits_array(two);
  bf256_t v3       = bf256_byte_combine_bits_array(three);
  if (dosq) {
    v1 = bf256_mul(v1, v1);
    v2 = bf256_mul(v2, v2);
    v3 = bf256_mul(v3, v3);
