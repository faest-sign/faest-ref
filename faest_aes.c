...
static void aes_128_inv_norm_to_conjugates_prover(bf128_t* y_val, bf128_t* y_tag,
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_val[i] = bf128_add(
        bf128_add(bf128_mul_bit(bf128_one(), x_val[0]), bf128_mul_bit(beta_square, x_val[1])),
        bf128_add(bf128_mul_bit(beta_square_1, x_val[2]), bf128_mul_bit(beta_cube, x_val[3])));
    y_tag[i] =
        bf128_add(bf128_add(bf128_mul(bf128_one(), x_tag[0]), bf128_mul(beta_square, x_tag[1])),
                  bf128_add(bf128_mul(beta_square_1, x_tag[2]), bf128_mul(beta_cube, x_tag[3])));
...
static void aes_192_inv_norm_to_conjugates_prover(bf192_t* y_val, bf192_t* y_tag,
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_val[i] = bf192_add(
        bf192_add(bf192_mul_bit(bf192_one(), x_val[0]), bf192_mul_bit(beta_square, x_val[1])),
        bf192_add(bf192_mul_bit(beta_square_1, x_val[2]), bf192_mul_bit(beta_cube, x_val[3])));
    y_tag[i] =
        bf192_add(bf192_add(bf192_mul(bf192_one(), x_tag[0]), bf192_mul(beta_square, x_tag[1])),
                  bf192_add(bf192_mul(beta_square_1, x_tag[2]), bf192_mul(beta_cube, x_tag[3])));
...
static void aes_256_inv_norm_to_conjugates_prover(bf256_t* y_val, bf256_t* y_tag,
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_val[i] = bf256_add(
        bf256_add(bf256_mul_bit(bf256_one(), x_val[0]), bf256_mul_bit(beta_square, x_val[1])),
        bf256_add(bf256_mul_bit(beta_square_1, x_val[2]), bf256_mul_bit(beta_cube, x_val[3])));
    y_tag[i] =
        bf256_add(bf256_add(bf256_mul(bf256_one(), x_tag[0]), bf256_mul(beta_square, x_tag[1])),
                  bf256_add(bf256_mul(beta_square_1, x_tag[2]), bf256_mul(beta_cube, x_tag[3])));
...
static void aes_128_inv_norm_to_conjugates_verifier(bf128_t* y_eval, const bf128_t* x_eval) {
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_eval[i] =
        bf128_add(bf128_add(bf128_mul(bf128_one(), x_eval[0]), bf128_mul(beta_square, x_eval[1])),
                  bf128_add(bf128_mul(beta_square_1, x_eval[2]), bf128_mul(beta_cube, x_eval[3])));
    beta_square   = bf128_mul(beta_square, beta_square);
    beta_square_1 = bf128_mul(beta_square_1, beta_square_1);
    beta_cube     = bf128_mul(beta_cube, beta_cube);
  }
...
static void aes_192_inv_norm_to_conjugates_verifier(bf192_t* y_eval, const bf192_t* x_eval) {
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_eval[i] =
        bf192_add(bf192_add(bf192_mul(bf192_one(), x_eval[0]), bf192_mul(beta_square, x_eval[1])),
                  bf192_add(bf192_mul(beta_square_1, x_eval[2]), bf192_mul(beta_cube, x_eval[3])));
    beta_square   = bf192_mul(beta_square, beta_square);
    beta_square_1 = bf192_mul(beta_square_1, beta_square_1);
    beta_cube     = bf192_mul(beta_cube, beta_cube);
  }
...
static void aes_256_inv_norm_to_conjugates_verifier(bf256_t* y_eval, const bf256_t* x_eval) {
  ...
  for (unsigned int i = 0; i != 4; ++i) {
    y_eval[i] =
        bf256_add(bf256_add(bf256_mul(bf256_one(), x_eval[0]), bf256_mul(beta_square, x_eval[1])),
                  bf256_add(bf256_mul(beta_square_1, x_eval[2]), bf256_mul(beta_cube, x_eval[3])));
    beta_square   = bf256_mul(beta_square, beta_square);
    beta_square_1 = bf256_mul(beta_square_1, beta_square_1);
    beta_cube     = bf256_mul(beta_cube, beta_cube);
  }
...
void aes_128_inv_norm_constraints_prover(bf128_t* z_deg0, bf128_t* z_deg1, bf128_t* z_deg2,
                                         const bf128_t* conjugates, const bf128_t* conjugates_tag,
                                         const bf128_t* y, const bf128_t* y_tag) {
  z_deg0[0] = bf128_mul(bf128_mul(*y_tag, conjugates_tag[1]), conjugates_tag[4]);
  // conjugates_tag[0]),

  z_deg1[0] = bf128_add(bf128_add(bf128_mul(bf128_mul(*y, conjugates_tag[1]), conjugates_tag[4]),
...
void aes_192_inv_norm_constraints_prover(bf192_t* z_deg0, bf192_t* z_deg1, bf192_t* z_deg2,
                                         const bf192_t* conjugates, const bf192_t* conjugates_tag,
                                         const bf192_t* y, const bf192_t* y_tag) {
...
void aes_256_inv_norm_constraints_prover(bf256_t* z_deg0, bf256_t* z_deg1, bf256_t* z_deg2,
                                         const bf256_t* conjugates, const bf256_t* conjugates_tag,
                                         const bf256_t* y, const bf256_t* y_tag) {
...
void aes_128_inv_norm_constraints_verifier(bf128_t* z_eval, const bf128_t* conjugates_eval,
                                           const bf128_t* y_eval, const bf128_t delta) {
  z_eval[0] = bf128_add(bf128_mul(bf128_mul(*y_eval, conjugates_eval[1]), conjugates_eval[4]),
                        bf128_mul(conjugates_eval[0], bf128_mul(delta, delta)));
}
void aes_192_inv_norm_constraints_verifier(bf192_t* z_eval, const bf192_t* conjugates_eval,
...
void aes_256_inv_norm_constraints_verifier(bf256_t* z_eval, const bf256_t* conjugates_eval,
...
void aes_128_state_to_bytes_prover(bf128_t* out, bf128_t* out_tag, const uint8_t* k,
                                   const bf128_t* k_tag, const faest_paramset_t* params) {
  unsigned int Nst_bytes = params->Nwd * 4;
...
void aes_192_state_to_bytes_prover(bf192_t* out, bf192_t* out_tag, const uint8_t* k,
                                   const bf192_t* k_tag, const faest_paramset_t* params) {
  uint16_t Nst_bytes = params->Nwd * 4;
...
static void aes_128_add_round_key_bytes_prover(bf128_t* y_deg0, bf128_t* y_deg1, bf128_t* y_deg2,
                                               const bf128_t* in_deg0, const bf128_t* in_deg1,
...
static void aes_192_add_round_key_bytes_prover(bf192_t* y_deg0, bf192_t* y_deg1, bf192_t* y_deg2,
                                               const bf192_t* in_deg0, const bf192_t* in_deg1,
...
static void aes_256_add_round_key_bytes_prover(bf256_t* y_deg0, bf256_t* y_deg1, bf256_t* y_deg2,
                                               const bf256_t* in_deg0, const bf256_t* in_deg1,
...
static void aes_128_bitwise_mix_column_verifier(bf128_t* out_key, bf128_t* s_keys_tag,
  ...
  for (unsigned int c = 0; c < Nst; c++) {
    ...
    //                     bf128_add(
    //                             bf128_add(b_bits_key[0], a_bits_key[3]), bf128_add(a_bits_key[2],
    //                             b_bits_key[1])
    //                             ), a_bits_key[1]);
    // out_key[c*4 + 1] = bf128_add(
    //                     bf128_add(
    //                             bf128_add(b_bits_key[1], a_bits_key[0]), bf128_add(a_bits_key[3],
    //                             b_bits_key[2])
    //                             ), a_bits_key[2]);
    // out_key[c*4 + 2] = bf128_add(
    //                     bf128_add(
    //                             bf128_add(b_bits_key[2], a_bits_key[1]), bf128_add(a_bits_key[0],
    //                             b_bits_key[3])
    //                             ), a_bits_key[3]);
    // out_key[c*4 + 3] = bf128_add(
    //                     bf128_add(
    //                             bf128_add(b_bits_key[3], a_bits_key[2]), bf128_add(a_bits_key[1],
    //                             b_bits_key[0])
    //                             ), a_bits_key[0]);
  }
}
static void aes_192_bitwise_mix_column_verifier(bf192_t* out_key, bf192_t* s_keys_tag,
  ...
  for (unsigned int c = 0; c < Nst; c++) {
    ...
    //                     bf192_add(
    //                             bf192_add(b_bits_key[0], a_bits_key[3]), bf192_add(a_bits_key[2],
    //                             b_bits_key[1])
    //                             ), a_bits_key[1]);
    // out_key[c*4 + 1] = bf192_add(
    //                     bf192_add(
    //                             bf192_add(b_bits_key[1], a_bits_key[0]), bf192_add(a_bits_key[3],
    //                             b_bits_key[2])
    //                             ), a_bits_key[2]);
    // out_key[c*4 + 2] = bf192_add(
    //                     bf192_add(
    //                             bf192_add(b_bits_key[2], a_bits_key[1]), bf192_add(a_bits_key[0],
    //                             b_bits_key[3])
    //                             ), a_bits_key[3]);
    // out_key[c*4 + 3] = bf192_add(
    //                     bf192_add(
    //                             bf192_add(b_bits_key[3], a_bits_key[2]), bf192_add(a_bits_key[1],
    //                             b_bits_key[0])
    //                             ), a_bits_key[0]);
  }
}
static void aes_256_bitwise_mix_column_verifier(bf256_t* out_key, bf256_t* s_keys_tag,
  ...
  for (unsigned int c = 0; c < Nst; c++) {
    ...
    //                     bf256_add(
    //                             bf256_add(b_bits_key[0], a_bits_key[3]), bf256_add(a_bits_key[2],
    //                             b_bits_key[1])
    //                             ), a_bits_key[1]);
    // out_key[c*4 + 1] = bf256_add(
    //                     bf256_add(
    //                             bf256_add(b_bits_key[1], a_bits_key[0]), bf256_add(a_bits_key[3],
    //                             b_bits_key[2])
    //                             ), a_bits_key[2]);
    // out_key[c*4 + 2] = bf256_add(
    //                     bf256_add(
    //                             bf256_add(b_bits_key[2], a_bits_key[1]), bf256_add(a_bits_key[0],
    //                             b_bits_key[3])
    //                             ), a_bits_key[3]);
    // out_key[c*4 + 3] = bf256_add(
    //                     bf256_add(
    //                             bf256_add(b_bits_key[3], a_bits_key[2]), bf256_add(a_bits_key[1],
    //                             b_bits_key[0])
    //                             ), a_bits_key[0]);
  }
}
...
static bf192_t* column_to_row_major_and_shrink_V_192(uint8_t** v, unsigned int ell) {
  ...
  bf192_t* new_v =
      faest_aligned_alloc(BF192_ALIGN, (ell + FAEST_192F_LAMBDA * 2) * sizeof(bf192_t));
...
static bf256_t* column_to_row_major_and_shrink_V_256(uint8_t** v, unsigned int ell) {
  ...
  // rows and \lambda columns storing in row-major order
  bf256_t* new_v =
      faest_aligned_alloc(BF256_ALIGN, (ell + FAEST_256F_LAMBDA * 2) * sizeof(bf256_t));
...
// // KEY EXP CSTRNTS
static void aes_128_expkey_constraints_prover(bf128_t* z_deg0, bf128_t* z_deg1, uint8_t* k,
                                              bf128_t* k_tag, const uint8_t* w,
                                              const bf128_t* w_tag,
                                              const faest_paramset_t* params) {

  unsigned int Ske    = params->Ske;
  unsigned int lambda = params->lambda;
  unsigned int Nk     = lambda / 32;
  ...
  for (unsigned int j = 0; j < Ske / 4; j++) {
    ...
    for (unsigned int r = 0; r < 4; r++) {
      ...
      z_deg1[8 * j + 2 * r] = bf128_add(
          bf128_add(bf128_mul(k_hat_sq[r], w_hat_tag[r]), bf128_mul(k_hat_tag_sq[r], w_hat[r])),
          k_hat_tag[r]);

      z_deg1[8 * j + 2 * r + 1] = bf128_add(
          bf128_add(bf128_mul(k_hat[r], w_hat_tag_sq[r]), bf128_mul(k_hat_tag[r], w_hat_sq[r])),
          w_hat_tag[r]);
...
static void aes_128_expkey_constraints_verifier(bf128_t* z_deg1, bf128_t* k_key,
  ...
  for (unsigned int j = 0; j < Ske / 4; j++) {
    ...
    for (unsigned int r = 0; r < 4; r++) {
      z_deg1[8 * j + 2 * r] =
          bf128_add(bf128_mul(k_hat_key_sq[r], w_hat_key[r]), bf128_mul(delta, k_hat_key[r]));
      z_deg1[8 * j + 2 * r + 1] =
          bf128_add(bf128_mul(k_hat_key[r], w_hat_key_sq[r]), bf128_mul(delta, w_hat_key[r]));
    }
    if (lambda == 192) {
      iwd += 192;
    } else {
...
// // ENC CSTRNTS
static void aes_128_enc_constraints_prover(bf128_t* z_deg0, bf128_t* z_deg1, bf128_t* z_deg2,
                                           const uint8_t* owf_in, const bf128_t* owf_in_tag,
  ...
  for (unsigned int r = 0; r < R / 2; r++) {
    ...
    for (unsigned int b = 0; b < 2; b++) {
      ...
      // ::22
      if (b == 0) {
        aes_128_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
                                           st_b_deg1[b], st_b_deg2[b], dummy_key, k_0_deg0,
                                           k_0_deg1, params);
      } else {
        aes_128_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
                                           st_b_deg1[b], st_b_deg2[b], k_1_deg0, k_1_deg1, k_1_deg2,
                                           params);
      }
    }
    // ::23-24
    ...
    for (unsigned int byte_i = 0; byte_i < Nstbytes; byte_i++) {
      ...
      z_deg1[(3 * r + 1) * Nstbytes + 2 * byte_i] = bf128_add(
          bf128_mul(s_sq_deg0, st_b_deg1[0][byte_i]), bf128_mul(s_sq_deg1, st_b_deg0[0][byte_i]));
...
static void aes_192_enc_constraints_prover(bf192_t* z_deg0, bf192_t* z_deg1, bf192_t* z_deg2,
  ...
  for (unsigned int r = 0; r < R / 2; r++) {
    ...
    for (unsigned int b = 0; b < 2; b++) {
      ...
      // ::22
      if (b == 0) {
        aes_192_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
                                           st_b_deg1[b], st_b_deg2[b], dummy_key, k_0_deg0,
                                           k_0_deg1, params);
      } else {
        aes_192_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
...
static void aes_256_enc_constraints_prover(bf256_t* z_deg0, bf256_t* z_deg1, bf256_t* z_deg2,
  ...
  for (unsigned int r = 0; r < R / 2; r++) {
    ...
    for (unsigned int b = 0; b < 2; b++) {
      ...
      // ::22
      if (b == 0) {
        aes_256_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
                                           st_b_deg1[b], st_b_deg2[b], dummy_key, k_0_deg0,
                                           k_0_deg1, params);
      } else {
        aes_256_add_round_key_bytes_prover(st_b_deg0[b], st_b_deg1[b], st_b_deg2[b], st_b_deg0[b],
...
static void aes_128_enc_constraints_verifier(bf128_t* z_key, const bf128_t* owf_in_key,
  ...
  for (unsigned int r = 0; r < R / 2; r++) {
    ...
    for (unsigned int i = 0; i < Nstbytes; i++) {
      ...
      // ::10-11
      aes_128_inv_norm_constraints_verifier(z_key + 3 * r * Nstbytes + i, state_conj_key + 8 * i,
                                            y_key, delta);
    ...
    for (unsigned int byte_i = 0; byte_i < Nstbytes; byte_i++) {
      ...
      z_key[(3 * r + 1) * Nstbytes + 2 * byte_i] = bf128_add(
          bf128_mul(s_sq_key, st_b_key[0][byte_i]), bf128_mul(delta, bf128_mul(delta, s_key)));
      // ::37
      // compute <s>^1 * <st_{1,i}>^2 - <st_{0,i}>^2
      //    s * st_{1,i} + delta * st_{0,i}
      //
      z_key[(3 * r + 1) * Nstbytes + 2 * byte_i + 1] =
          bf128_add(bf128_mul(s_key, st_b_key[1][byte_i]), bf128_mul(delta, st_b_key[0][byte_i]));
    }
    if (r != (R / 2) - 1) {
...
static void aes_128_constraints_prover(bf128_t* z_deg0, bf128_t* z_deg1, bf128_t* z_deg2,
  ...
  unsigned int R                   = params->R;
  unsigned int Ske                 = params->Ske;
  unsigned int Lke                 = params->Lke;
  unsigned int Lenc                = params->Lenc;
  unsigned int Senc                = params->Senc;
  unsigned int Nk                  = lambda / 32;
  unsigned int Nst                 = params->Nwd; // In Round 1, Nwd was Nst
  unsigned int num_enc_constraints = 3 * Senc / 2;
  uint16_t blocksize               = 32 * params->Nwd;
  ...
  z_deg2[0] = bf128_add(bf128_mul_bit(w_tag[0], w[1]), bf128_mul_bit(w_tag[1], w[0]));
  // ::7-8
  uint8_t* in        = malloc(blocksize);
  bf128_t* in_tag    = faest_aligned_alloc(BF128_ALIGN, sizeof(bf128_t) * blocksize);
  uint8_t* out       = malloc(blocksize);
  bf128_t* out_tag   = faest_aligned_alloc(BF128_ALIGN, sizeof(bf128_t) * beta * blocksize);
  ...
  if (faest_is_em(params)) {
    ...
    // ::15 skiped as B = 1
    // ::16
    bf128_t* z_tilde_deg0_tag = faest_aligned_alloc(BF128_ALIGN, 2 * Ske * sizeof(bf128_t));
    bf128_t* z_tilde_deg1_val = faest_aligned_alloc(BF128_ALIGN, 2 * Ske * sizeof(bf128_t));
    aes_128_expkey_constraints_prover(z_tilde_deg0_tag, z_tilde_deg1_val, rkeys, rkeys_tag, w,
  ...
  for (unsigned int b = 0; b < beta; b++) {
    ...
    aes_128_enc_constraints_prover(z_tilde_deg0, z_tilde_deg1, z_tilde_deg2, in, in_tag, out,
                                   out_tag, w_tilde, w_tilde_tag, rkeys, rkeys_tag, params);
    // uint32_t z_offset = 1 + (2*FAEST_128F_Ske);
    // printf("z offset = %d\n", z_offset);
    // aes_128_enc_constraints_prover(z_deg0 + z_offset, z_deg1 + z_offset, z_deg2 + z_offset, in,
    // in_tag, out, out_tag, w_tilde, w_tilde_tag, k, k_tag, params);
...
static void aes_128_constraints_verifier(bf128_t* z_key, const bf128_t* w_key,
  ...
  // ::7-8
  bf128_t* rkeys_key = faest_aligned_alloc(BF128_ALIGN, sizeof(bf128_t) * (R + 1) * blocksize);
  ...
  if (faest_is_em(params)) {
    ...
    // ::16
    bf128_t* z_tilde_key = faest_aligned_alloc(BF128_ALIGN, 2 * Ske * sizeof(bf128_t));
  ...
  // ::18-20
  bf128_t* w_tilde_key = faest_aligned_alloc(BF128_ALIGN, Lenc * sizeof(bf128_t));
  bf128_t* z_tilde_enc_key =
      faest_aligned_alloc(BF128_ALIGN, num_enc_constraints * sizeof(bf128_t));
...
static void aes_192_constraints_verifier(bf192_t* z_key, const bf192_t* w_key,
  ...
  // ::7-8
  bf192_t* rkeys_key = faest_aligned_alloc(BF192_ALIGN, sizeof(bf192_t) * (R + 1) * blocksize);
  ...
  if (faest_is_em(params)) {
    ...
    // ::16
    bf192_t* z_tilde_key = faest_aligned_alloc(BF192_ALIGN, 2 * Ske * sizeof(bf192_t));
  ...
  bf192_t* z_tilde_enc_key =
      faest_aligned_alloc(BF192_ALIGN, num_enc_constraints * sizeof(bf192_t));
...
static void aes_256_constraints_verifier(bf256_t* z_key, const bf256_t* w_key,
  ...
  // ::7-8
  bf256_t* rkeys_key = faest_aligned_alloc(BF256_ALIGN, sizeof(bf256_t) * (R + 1) * blocksize);
  ...
  if (faest_is_em(params)) {
    ...
    // ::16
    bf256_t* z_tilde_key = faest_aligned_alloc(BF256_ALIGN, 2 * Ske * sizeof(bf256_t));
  ...
  bf256_t* z_tilde_enc_key =
      faest_aligned_alloc(BF256_ALIGN, num_enc_constraints * sizeof(bf256_t));
...
static void aes_128_prover(uint8_t* a0_tilde, uint8_t* a1_tilde, uint8_t* a2_tilde,
  ...
  unsigned int lambda = params->lambda;
  unsigned int c      = params->C;
  unsigned int ell    = params->l;
  ...
  // ::10-12
  bf128_t* z0_tag =
      faest_aligned_alloc(BF128_ALIGN, c * sizeof(bf128_t)); // this contains the bf tag
  bf128_t* z1_val =
      faest_aligned_alloc(BF128_ALIGN, c * sizeof(bf128_t)); // this contains the bf val
  bf128_t* z2_gamma =
      faest_aligned_alloc(BF128_ALIGN, c * sizeof(bf128_t)); // this contains the bf gamma
...
static void aes_192_prover(uint8_t* a0_tilde, uint8_t* a1_tilde, uint8_t* a2_tilde,
  ...
  // ::10-12
  bf192_t* z0_tag =
      faest_aligned_alloc(BF192_ALIGN, c * sizeof(bf192_t)); // this contains the bf tag
  bf192_t* z1_val =
      faest_aligned_alloc(BF192_ALIGN, c * sizeof(bf192_t)); // this contains the bf val
  bf192_t* z2_gamma =
      faest_aligned_alloc(BF192_ALIGN, c * sizeof(bf192_t)); // this contains the bf gamma
...
static void aes_256_prover(uint8_t* a0_tilde, uint8_t* a1_tilde, uint8_t* a2_tilde,
  ...
  // ::10-12
  bf256_t* z0_tag =
      faest_aligned_alloc(BF256_ALIGN, c * sizeof(bf256_t)); // this contains the bf tag
  bf256_t* z1_val =
      faest_aligned_alloc(BF256_ALIGN, c * sizeof(bf256_t)); // this contains the bf val
  bf256_t* z2_gamma =
      faest_aligned_alloc(BF256_ALIGN, c * sizeof(bf256_t)); // this contains the bf gamma
